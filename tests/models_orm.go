...
func (m *OmitEmptyDemo) ModelName() string { return "omit_empty_demo" }

func (m *OmitEmptyDemo) Schema() []model.Field { return OmitEmptyDemoModel.Fields }

func (m *OmitEmptyDemo) Pointers() []any { return []any{&m.Id, &m.Email, &m.Nickname} }

func (m *OmitEmptyDemo) IsNil() bool { return m == nil }

func (m *OmitEmptyDemo) EncodeFields(w model.FieldWriter) {
	w.String("id", m.Id)
	if m.Email != "" { w.String("email", m.Email) }
	w.String("nickname", m.Nickname)
}

func (m *OmitEmptyDemo) DecodeFields(r model.FieldReader) {
	if v, ok := r.String("id"); ok { m.Id = v }
	if v, ok := r.String("email"); ok { m.Email = v }
	if v, ok := r.String("nickname"); ok { m.Nickname = v }
}

type OmitEmptyDemoList []*OmitEmptyDemo

func (s *OmitEmptyDemoList) Schema() []model.Field { return nil }
func (s *OmitEmptyDemoList) Pointers() []any     { return nil }
func (s *OmitEmptyDemoList) Len() int             { return len(*s) }
func (s *OmitEmptyDemoList) At(i int) model.Fielder { return (*s)[i] }
func (s *OmitEmptyDemoList) Append() model.Fielder  { v := &OmitEmptyDemo{}; *s = append(*s, v); return v }
func (s *OmitEmptyDemoList) IsNil() bool          { return s == nil }
func (s *OmitEmptyDemoList) EncodeFields(_ model.FieldWriter) {}
func (s *OmitEmptyDemoList) DecodeFields(_ model.FieldReader) {}

func (m *OmitEmptyDemo) Validate(action byte) error {
	return model.ValidateFields(action, m)
}

var OmitEmptyDemo_ = struct {
	Id string
	Email string
	Nickname string
}{
...
func ReadOneOmitEmptyDemo(qb *orm.QB, model *OmitEmptyDemo) (*OmitEmptyDemo, error) {
	err := qb.ReadOne()
	if err != nil {
		return nil, err
	}
...
func ReadAllOmitEmptyDemo(qb *orm.QB) (OmitEmptyDemoList, error) {
	var results OmitEmptyDemoList
	err := qb.ReadAll(
		func() model.Model { return &OmitEmptyDemo{} },
		func(m model.Model) { results = append(results, m.(*OmitEmptyDemo)) },
	)
	return results, err
}
